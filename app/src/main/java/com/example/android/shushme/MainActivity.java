...
public class MainActivity extends AppCompatActivity implements
    ...
    public void refreshPlacesData() {
        ...
        if (placesCursor == null) return;
        while (placesCursor.moveToNext()) {
            placesList.add(placesCursor.getString(placesCursor.getColumnIndex(PlaceContract.PlaceEntry.COLUMN_PLACE_ID)));
        }
        PendingResult<PlaceBuffer> pendingPlaces = Places.GeoDataApi.getPlaceById(mClient, placesList.toArray(new String[0]));
        pendingPlaces.setResultCallback(new ResultCallback<PlaceBuffer>() {
            @Override
